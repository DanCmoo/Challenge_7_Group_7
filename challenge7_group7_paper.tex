...
However, the synthetic images introduce painterly artefacts absent from true Clipart,
limiting the alignment.
The key tradeoff is clear: target fine-tuning requires 40 labelled target images per
